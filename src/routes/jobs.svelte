...
<svelte:head>
  <title>List of Emerging Jobs | Atlas of Emerging Jobs</title>
</svelte:head>

<TopNav subtitle="List of Emerging Jobs" />

<div
  class="pattern bg-black text-gray-100 pt-16 md:pt-24 px-2 md:px-4 lg:px-36"
>
  <button
    class="text-gray-300 fixed top-16 left-2 mb-4 flex items-center !z-30"
    ...
    <div class="text-gray-400 py-10">
      <div class="grid grid-cols-1 md:grid-cols-2 md:items-center">
        ...
        <div
          ...
          class="pb-4 px-2 md:px-4"
        >
          <h1
            class="text-gray-200 text-4xl md:text-5xl h-font uppercase mb-6 font-semibold text-center md:text-left"
          >
            {vc.name}
          </h1>

          <div class="flex md:hidden justify-center items-center relative mb-6">
            <FrameCard img={vc.img} />
          </div>
        ...
        <!-- Right -->
        <div
          class="hidden md:flex frame-parent justify-center items-center relative py-10"
          data-aos="fade-left"
          data-aos-anchor-placement="top-bottom"
          data-aos-delay="400"
          data-aos-offset="0"
